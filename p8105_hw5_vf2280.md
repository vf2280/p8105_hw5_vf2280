...
ldl_df %>%
  ...
  ggplot(aes(x = week, y = ldl, color = subject_id)) +
  labs(
...
<img src="p8105_hw5_vf2280_files/figure-gfm/unnamed-chunk-10-2.png" width="90%" />
...
Final dataset containing tidy t-test values of simulaitons with
specified sample size, mu values, and sigma value.
...
<img src="p8105_hw5_vf2280_files/figure-gfm/unnamed-chunk-15-1.png" width="90%" />

Functions to make plots of average estimate of mu vs true value of mu
and average estimate of mu hat vs true value of mu.
...
<img src="p8105_hw5_vf2280_files/figure-gfm/unnamed-chunk-17-1.png" width="90%" />
